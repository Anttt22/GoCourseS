...
//Interface embedding - встраивание интерфейсов
...
//чтобы удовлетворять иртерфейсу Iphone надо удовлетворять
//надо реализовать все методы включенных интерфейсов и собственных методов
